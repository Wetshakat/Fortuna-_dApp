    ...
    <Card className="card-elevated p-6 space-y-4">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-slate-400 text-sm">Round #1</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-slate-800/50 rounded-lg p-3">
          ...
          <p className="text-2xl font-bold text-white">58m</p>
        </div>
        <div className="bg-slate-800/50 rounded-lg p-3">
          <div className="text-slate-400 text-sm mb-1">Prize Pool</div>
          <p className="text-2xl font-bold text-emerald-400">1,200 USDC</p>
        </div>
      </div>
